...
from transformers import LiltModel, AutoModelForCausalLM, AutoTokenizer, BartForConditionalGeneration
...
from src.models.docsblip import QFormerAdapter, generate_closed_instr
...
class DocsBlip(LightningModule):
    def __init__(
        ...
        self.decoder = BartForConditionalGeneration.from_pretrained(decoder_name).eval()
