...
class WMD:
    ...
    def __init__(self):
        ...
        self.model = gensim.models.KeyedVectors.load_word2vec_format(os.path.join(os.path.abspath(os.path.dirname(__file__)), 'data', 'GoogleNews-vectors-negative300.bin.gz'), binary=True)
        self.sigma = 1.0
